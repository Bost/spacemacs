...
(defun helm/init-helm ()
  (use-package helm
    ...
    (spacemacs||set-helm-key "sgB" '("grep-search buffers w/ input" . spacemacs/helm-buffers-do-grep-region-or-symbol))
    (spacemacs||set-helm-key "sgf" spacemacs/helm-files-do-grep)
    (spacemacs||set-helm-key "sgF" '("grep-search files w/ input" . spacemacs/helm-files-do-grep-region-or-symbol))
    (spacemacs||set-helm-key "sgg" spacemacs/helm-file-do-grep)
    (spacemacs||set-helm-key "sgG" '("grep-search file w/ input" . spacemacs/helm-file-do-grep-region-or-symbol))
